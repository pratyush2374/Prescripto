...
import sendAppointmentEmail from "../lib/sendEmail.js";
...
const getSummary = async (req, res) => {
    try {
        ...
        try {
            ...
            // Delete the file in case of parsing error
        ...
        try {
            ...
            // Delete the file in case of upload error
            await fs.unlink(req.file.path);
...
const previousReports = async (req, res) => {
    try {
        const { userId } = req.body;
        if (!userId) {
        ...
        const reports = await userReportsModel.find({ userId });
        console.log(reports);
